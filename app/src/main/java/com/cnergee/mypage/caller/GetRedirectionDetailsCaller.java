...
//            }else
                if(Utils.is_payU){
                    MakeMyPayment_PayU.rslt = getRedirectionDetailsSOAP.CallComplaintNoSOAP();
                    MakeMyPayment_PayU.MapRedirectionDetails = getRedirectionDetailsSOAP.getMapRedictionDetail();
