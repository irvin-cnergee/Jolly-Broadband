...
public class ChangePackage_NewActivity extends Activity{
    ...
    Dialog pg_dialog;
    String MyPageAdjustmentAllowed,adjPackageRate,AdjustedAmount,TotalAllotedData,TotalUsedData;
    /*@Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyPageAdjustmentAllowed = sharedPreferences.getString("MyPageAdjustmentAllowed","");
...
//                    }
                 ...
                 /*   if(tv_pkg_name.getText().toString().length()>0){
                    ...
                    if(MyPageAdjustmentAllowed.equals("1")) {
...
//					AlertsBoxFactory.showAlert(Utils.CAvenue_Message, ChangePackage.this);
    ...
    public void show_payment_options(){
        ...
        int	payu=sharedPreferences1.getInt(Utils.PayU, 0);


        Utils.log("paytm1", ":"+ebs);
        Utils.log("is_CCAvenue", ":"+CCAvenue);
        ...
        } else if (payu>0)
        {
            ...
            if(isPhonerenew >0)
            {
                AlertsBoxFactory.showAlert(getResources().getString(R.string.phone_renew), ChangePackage_NewActivity.this);
